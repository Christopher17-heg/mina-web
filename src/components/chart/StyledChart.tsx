...
export function StyledChart(props: ChartProps) {
  ...
  // Use token values directly since useToken is not available in v3
  const textColorPrimary = 'var(--chakra-colors-TextPrimary)';
  const textColorSecondary = 'var(--chakra-colors-TextSecondary)';
